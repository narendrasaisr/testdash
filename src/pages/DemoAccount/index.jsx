...
const DemoAccountPage = () => {
  return (
    <>
      <div className="bg-gray-50 flex sm:flex-col md:flex-col flex-row font-gilroy gap-[30px] items-start mx-auto sm:pr-5 pr-6 w-full">
                  ...
                  <div className="md:h-[201px] h-[350px] relative w-[96%]">
                    ...
                    <div className="absolute flex flex-col gap-11 items-start justify-start left-[0] pt-0.5 top-[0] w-[77%]">
                      ...
                      <div className="flex flex-col gap-4 items-start justify-start rounded-md w-full">
                        ...
                        <Button
                          className="cursor-pointer font-medium rounded-md text-center text-sm w-[119px]"
                          color="blue_A700"
                        >
                          Learn More
                        </Button>

...
const AdhocReportingPage = () => {
  return (
    <>
      <div className="bg-gray-50 flex sm:flex-col md:flex-col flex-row font-gilroy gap-[30px] items-start mx-auto w-full">
        ...
        <div className="flex-1 sm:h-[1056px] h-[1109px] md:h-[2276px] md:mt-0 mt-6 md:px-5 relative w-full">
            ...
            <div className="flex flex-col gap-[30px] items-start justify-start w-[98%] md:w-full">
              <div className="flex md:flex-col flex-row md:gap-10 gap-[79px] items-start justify-start ml-0.5 md:ml-[0] w-[81%] md:w-full">
                <div className="h-[50px] relative w-[46%] md:w-full">
                  <div className="absolute bg-gray-50_01 border-b border-blue_gray-100 border-solid flex flex-row gap-9 h-full inset-[0] items-start justify-center m-auto pb-1 pr-1 w-full">
                        ...
                        >
                          <div className="flex flex-col gap-5 items-center justify-start mt-[3px] w-[91%] md:w-full">
                            <div className="h-[78px] relative rounded-[10px] w-[78px]">
                              ...
                              <Text
                                className="absolute h-max inset-[0] justify-center m-auto text-base text-gray-900 w-max"
                                size="txtGilroySemiBold16Gray900"
                              >
                                90%
                              </Text>
                            </div>
          ...
          <div className="absolute bg-gray-50_01 md:h-[1056px] h-[1109px] inset-y-[0] my-auto pb-[53px] right-[2%] shadow-bs w-[23%]">
